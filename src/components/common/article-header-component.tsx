...
const menuItems = [
  ...
  { icon: LinkIcon, title: "しりとりシステム", path: "/shiritori" },
  { icon: Dices, title: "サイコロシステム", path: "/dice" },
  { icon: CaseUpper, title: "アルファベットシステム", path: "/alphabet" },
  { icon: Map, title: "都道府県システム", path: "/prefectures" },
  { icon: Frame, title: "方眼紙", path: "/graphpaper" },
];
