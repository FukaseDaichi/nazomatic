...
- 2026-09-11: 画像生成子プロセスの timeout で stderr を捨てると、参照準備・ツール待機・保存のどこで停止したか追跡できない。上限と経過時間、失敗直前の出力末尾をローカル CLI ログに残すと、次回の遅延原因を調べられる。
...
- なし。2026-08-31 のゆる出題 URL 不在は、CLI の成功判定後にユーザーが投稿を削除したことが原因と確認済み。
